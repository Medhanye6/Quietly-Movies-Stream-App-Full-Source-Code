        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={[styles.responsiveWrapper, isDesktop && styles.desktopCenter]}>
            <View style={styles.container}>
              ...
              <Text style={[styles.heading, { fontSize: sFont(26) }]}>Create account</Text>
              <Text style={[styles.subheading, { fontSize: sFont(15) }]}>Join and start streaming for free</Text>
              ...
              <View style={styles.field}>
                <Text style={[styles.label, { fontSize: sFont(13) }]}>Display name (optional)</Text>
                <TextInput
              ...
              <Focusable style={styles.submitBtn} onPress={handleSignup}>
                {loading ? <ActivityIndicator color="#fff" /> : <Text style={[styles.submitTxt, { fontSize: sFont(16) }]}>Create Account</Text>}
              </Focusable>

              <View style={styles.switchRow}>
                <Text style={[styles.switchTxt, { fontSize: sFont(14) }]}>Already have an account? </Text>
                <Focusable onPress={() => router.replace("/auth/login" as any)}>
                  <Text style={[styles.switchLink, { fontSize: sFont(14) }]}>Log in</Text>
                </Focusable>
              </View>
            </View>
          </View>
